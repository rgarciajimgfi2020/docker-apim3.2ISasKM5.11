DROP DATABASE IF EXISTS WSO2AM_SHARED_IS;
CREATE DATABASE WSO2AM_SHARED_IS;
GRANT ALL ON WSO2AM_SHARED_IS.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
USE WSO2AM_SHARED_IS;
